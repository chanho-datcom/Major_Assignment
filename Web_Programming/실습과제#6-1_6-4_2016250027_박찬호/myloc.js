...
function computeDistance(startCoords, destCoords){
    ...
    var destLatrRads = degreesToRadians(destCoords.latitude);
    var destLongRads = degreesToRadians(destCoords.longitude);

    var Radius = 6371;
    var distance = Math.acos(Math.sin(startLatRads) * Math.sin(destLatrRads) +
                    Math.cos(startLatRads) * Math.cos(destLatrRads) *
