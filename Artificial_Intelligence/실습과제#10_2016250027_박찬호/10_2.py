...
print("\nExercise: Then train various classifiers, \n"
      "such as a Random Forest classifier, \n"
...
print("\nLet's remove the SVM to see if performance improves. \n"
      "It is possible to remove an estimator by setting it to None using set_params() like\n"
      "this:")
...
print("\nThe voting classifier only very slightly reduced \n"
      "the error rate of the best model in this case.")